...
const User = (props) => {
  ...
  return (
    <span draggable={true} onDragStart={start} onDrop={drop} onDragEnd={drop} className="tag" style={{
      color: '#3b5998',
      textDecoration: 'underline',
          ...
          <div className="row around-xs">
            <div className="col-1">
              <Popup ref="toolbar" type="select" position="bottom left" openOnFocus openOnClick closeOnEsc closeOnOutsideClick element={
                <Button type="empty" size="xs" unactive={true} style={{
                  position: 'absolute',
                  ...
                  <div className="col-3">
                    <Modal size="small" level={-2} openOnClick closeOnEsc closeOnOutsideClick element={
                      ...
                      <ProveModal title="Link" type="empty" onProve={async () => this.confirmLink()}>
                        <Popup type="error" position="top center" openOnFocus openOnOverMove closeOnOutsideClick closeOnBlur closeOnOutMove closeOnOutMovePop timeout={300} isHidden={true} element={
